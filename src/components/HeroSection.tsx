          ...
          <div className="text-white animate-fade-in-up">
            <div className="flex items-center gap-4 mb-6">
              <img 
                ...
                className="w-16 h-16 object-cover rounded-full shadow-primary"
              />
              <div>
                <h1 className="text-5xl lg:text-7xl font-bold mb-2">
                  <span className="gradient-text">Neel Kanth</span>
                </h1>
                <p className="text-2xl font-semibold text-accent-light">Traders</p>
              </div>
            </div>
            
            <p className="text-xl mb-8 text-primary-foreground/90">
              Authorized distributor of premium construction materials including Birla, UltraTech, 
              and leading cement brands. Building India's future with quality and trust.
            </p>
            ...
            <div className="flex gap-4">
              <button className="bg-accent hover:bg-accent-light text-accent-foreground px-8 py-3 rounded-lg font-semibold transition-smooth hover-lift">
                View Products
              </button>
              <button className="border-2 border-accent text-accent hover:bg-accent hover:text-accent-foreground px-8 py-3 rounded-lg font-semibold transition-smooth">
                Contact Us
              </button>
            </div>
          </div>
